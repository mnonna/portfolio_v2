    ...
    <b-row class="technologies-main__row">
      <b-col class="technologies-main__col" cols="12">
        <div class="technologies-main__wrapper">
          <div class="tech-header d-flex justify-content-around align-items-center">
...
export default {
  ...
  mounted() {
    ...
    t1.from(header, { opacity: 0 }).to(header, 0.5, { opacity: 1 });

    thumbs.forEach(thumb => {
      t1.from(thumb, { left: -100, scale: 0, duration: 0.15 }).to(thumb, {
        left: 0,
        scale: 0.8,
        duration: 0.15
      });
