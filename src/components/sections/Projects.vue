  ...
  <b-container fluid class="projects-container" id="projects">
    <b-row class="projects-container__row d-flex justify-content-center align-items-center">
      <b-col
        ...
        xl="8"
      >
        <div class="projects-header d-flex justify-content-around align-items-center">
            ...
            <g>
              <g>
                <rect
                  x="402.113"
                  y="334.822"
                  transform="matrix(0.6401 -0.7683 0.7683 0.6401 -133.6437 446.8239)"
                  width="16"
                  height="62.48"
                />
              </g>
            ...
            <g>
              <g>
                <rect
                  x="9.128"
                  y="130.058"
                  transform="matrix(0.9701 -0.2425 0.2425 0.9701 -32.2251 14.3351)"
                  width="65.968"
                  height="15.992"
                />
              </g>
            ...
            <g>
              <g>
                <rect
                  x="46.111"
                  y="35.657"
                  transform="matrix(0.5812 -0.8137 0.8137 0.5812 -34.3557 73.3688)"
                  width="15.992"
                  height="68.816"
                />
              </g>
            ...
            <g>
              <g>
                <rect
                  x="97.938"
                  y="1.024"
                  transform="matrix(0.9688 -0.2477 0.2477 0.9688 -5.133 27.2971)"
                  width="16"
                  height="66.056"
                />
              </g>
...
export default {
  ...
  data() {
    return {
      projects: [
        {
          id: 1,
          url: require("../../assets/img/noteify.jpg"),
          name: "Noteify App",
        ...
        {
          id: 2,
          url: require("../../assets/img/ehc.jpg"),
          name: "EHC App",
        ...
        {
          id: 3,
          url: require("../../assets/img/swisher.jpg"),
          name: "Swisher App",
        ...
        {
          id: 4,
          url: require("../../assets/img/portfolio.jpg"),
          name: "Portfolio",
  ...
  mounted() {
    ...
    projects.forEach(project => {
      t1.from(project, { top: -200, opacity: 0 }).to(project, 0.1, {
        top: 0,
        opacity: 1
      });
    });
